...
<template>
  <div class="box">
      ...
      <table class="table table-bordered table-striped">
        ...
        >
          ...
          <tr>
            ...
            <td>
              <div align="center">
                <strong class="">{{ quiz_attempt.user.last_name }}, {{ quiz_attempt.user.first_name }}</strong>
                <br>
                {{ quiz_attempt.user.username }}
              </div>
            </td>
            <td><strong class="green">{{ quiz_attempt.candidate_point }}/{{ quiz_attempt.score_limit }}</strong></td>
    ...
    <el-dialog
      ...
      :title="view_detail.user.first_name + ' ' + view_detail.user.last_name"
      width="99%"
    >
      <div>
        <table class="table">
