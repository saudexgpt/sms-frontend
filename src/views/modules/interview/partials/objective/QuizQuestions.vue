                  ...
                  <div class="controls">
                    ...
                    <div id="opt11">
                      <el-radio
                        ...
                        v-model="quiz.candidate_answer"
                        label="A"
                        border
                        size="medium"
                        @change="quiz.candidate_answer_option = quiz.question.optA"
                      />
                      <span
                      ...
                      <el-radio
                        ...
                        border
                        size="medium"
                        @change="quiz.candidate_answer_option = quiz.question.optB"
                      />
                      ...
                      <el-radio
                        ...
                        border
                        size="medium"
                        @change="quiz.candidate_answer_option = quiz.question.optC"
                      />
                      <span v-html="quiz.question.optC" />
                      <hr>
                      <el-radio
                        v-if="quiz.question.optD !== null"
                        v-model="quiz.candidate_answer"
                        label="D"
                        border
                        size="medium"
                        @change="quiz.candidate_answer_option = quiz.question.optD"
                      />
                      <span
                        v-if="quiz.question.optD !== null"
                        v-html="quiz.question.optD"
                      />
                      <hr>
                      <!-- <label
                        for="ansA"
                      ...
                      <input
                        ...
                        value="A"
                        type="radio"
                        @click="quiz.candidate_answer_option = quiz.question.optA"
                      ...
                      <input
                        ...
                        value="B"
                        type="radio"
                        @click="quiz.candidate_answer_option = quiz.question.optB"
                      ...
                      <input
                        ...
                        value="C"
                        type="radio"
                        @click="quiz.candidate_answer_option = quiz.question.optC"
                      ...
                      <input
                        ...
                        value="D"
                        type="radio"
                        @click="quiz.candidate_answer_option = quiz.question.optD"
        ...
        >
          ...
          >
            <h4><font color="green">
              ...
              <strong>{{ quiz.candidate_answer }}</strong>
            </font>)<span v-html="quiz.candidate_answer_option" /></h4><br>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          <div style="background: #000; color: #ffffff; padding: 30px; ">
            ...
            <h3>Score Board </h3>
            <h2>{{ 'Score: '+submit_response.candidate_point+'/'+submit_response.limit }}</h2>
...
export default {
  ...
  methods: {
    ...
    colorButton(current) {
      ...
      // }
      document.getElementById(`quest_button_${current}`).style.backgroundColor = '#ccc'
      if (this.answers[current].candidate_answer != null) {
    ...
    attemptQuiz() {
      ...
      const attemptQuizResource = new Resource('interview/attempt-quiz')
      const param = {
      ...
      attemptQuizResource.store(param) // back end route from web.php
        ...
        .then(response => {
          ...
          if (app.quiz_attempt.remaining_time < 1 || app.quiz_attempt.has_submitted === 'yes') {
            app.timeup = true
            app.submitted = true
            app.score_board_message = `YOU HAVE TAKEN TEST #${app.compiledQuiz.id} ALREADY`
            app.doSubmit()
          }
          // app.checkKeyDown()
        }).catch(() => {
    ...
    checkTime() {
      ...
      app.timeup = true
      app.submitted = true
      app.score_board_message = 'TIME IS UP!!!<br>TEST SUBMITTED AUTOMATICALLY'
      app.doSubmit()
    },
    doSubmit() {
      const app = this
      app.loader = true
      const submitQuizResource = new Resource('interview/submit-quiz-answers')
    ...
    saveAnswers() {
      ...
      if (window.confirm('Are you sure you want to submit?')) {
        app.score_board_message = 'TEST SUBMITTED SUCCESSFULLY'
        app.doSubmit()
      }
    },
  },
