...
const teacherClasses = new Resource('attendance/classes')
const attendanceCreate = new Resource('attendance/create/class')
const attendanceStore = new Resource('attendance/store/class')
export default {
  components: { DndList },
  data() {
    return {
  ...
  methods: {
    ...
    storeAttendance() {
      ...
      param.class_teacher_id = app.form.class_teacher_id
