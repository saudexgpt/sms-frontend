            ...
            >
              ...
              >
                <div class="alert-body">
                  <span><strong>Give these credentials to the staff. The password can then be changed on first login. </strong></span>
                </div>
              </b-alert>
              <h5 class="mb-0">
                Login Credentials
...
export default {
  ...
  methods: {
    ...
    formSubmitted() {
      const app = this
      const saveStudentResource = new Resource('user-setup/staff/store')
      const { form } = app
