  ...
  computed: {
    ...
    publishedResults() {
      if (this.fetched_data.term_spec === 'half') {
        return this.fetched_data.student_results.filter(i => (i.result_action_array && i.result_action_array[2] === 'published'))
      }
      return this.fetched_data.student_results.filter(i => (i.result_action_array && i.result_action_array[3] === 'published'))
    },
