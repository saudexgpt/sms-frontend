...
import CreateCurriculumLevel from './partials/CreateCurriculumLevelGroup.vue'
import EditCurriculumLevel from './partials/EditCurriculumLevelGroup.vue'
...
export default {
  ...
  methods: {
    fetchcurriculumLevelGroups() {
      const app = this
      app.loading = true
      const fetchCurriculumSetupResource = new Resource('curriculum/level-group/all')
      fetchCurriculumSetupResource.list()
        .then(response => {
          app.curriculumLevelGroups = response.curriculum_level_groups
          app.loading = false
        })
    },
    updateTable(curriculum) {
      const app = this
      app.curriculumLevelGroups.unshift(curriculum)
    },
    ...
    updateEditedTableRow() {
      const app = this
      app.fetchcurriculumLevelGroups()
    },
  },
}
</script>
