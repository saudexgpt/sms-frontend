  ...
  computed: {
    ...
    get_ext_img() {
      return ext => {
        ...
        if (ext === 'jpg') return require('@assets/images/file-icons/jpg.png')
        if (ext === 'xls') return require('@assets/images/file-icons/xls.png')
        if (ext === 'pdf') return require('@assets/images/file-icons/pdf.png')
        return require('@assets/images/file-icons/doc.png')
      }
    },
  },
  methods: {
