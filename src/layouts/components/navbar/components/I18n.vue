...
export default {
  computed: {
    i18n_locale_img() {
      ...
      if (locale === 'pt') return require('@assets/images/flags/pt.png')
      if (locale === 'fr') return require('@assets/images/flags/fr.png')
      if (locale === 'de') return require('@assets/images/flags/de.png')
